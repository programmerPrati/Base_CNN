...
import numpy as np
try:
    from cs6353.im2col_cython import col2im_cython, im2col_cython
    from cs6353.im2col_cython import col2im_6d_cython
except ImportError:
    print('run the following from the cs6353 directory and try again:')
    print('python setup.py build_ext --inplace')
    print('You may also need to restart your iPython kernel')

from cs6353.im2col import *
